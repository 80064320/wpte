...
if ( ! ( 'banner-default' === $banner_layout || 'banner-layout-1' === $banner_layout || 'banner-layout-6' === $banner_layout || isset( $args[ 'related_query' ] ) ) ) {
...
$default_banner_class 			= ! isset( $args[ 'related_query' ] ) && 'banner-default' === $banner_layout ? ' banner-layout-default' : ' ' . $banner_layout; //Add default class for banner only.
				...
				<div class="wpte-gallery-container">
					...
					if ( ! empty( $gallery_images ) ) :
						...
						<a data-galtarget="#wte-image-gallary-popup-<?php echo esc_attr( $post->ID . $random ); ?>"
							...
							class="wte-trip-image-gal-popup-trigger"><?php esc_html_e( 'Gallery', 'gowilds' ); ?>
						</a>
					</span>
					<?php endif; ?>
