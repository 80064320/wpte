...
?>
<div class="trip-one__single<?php echo esc_attr($content_classes) ?>">
	<div class="trip-one__wrap">
	   <?php if(has_post_thumbnail()){ ?>
	      <div class="trip-one__image">
	   ...
	   <div class="trip-one__content">
	  		<div class="trip-one__content-top">
	   	...
	   	<?php 
		   	if($enable_video_gallery || $images){ 
			   	echo '<div class="trip__media trip-one__media">';
		   			if($images){
		            	$i = 1;
         ...
         <h3 class="trip-one__title">
         	<a href="<?php echo esc_url( get_permalink() ) ?>" rel="bookmark"><?php the_title() ?></a>
         </h3>
         <?php if(!empty($location_address)){  ?>
	      	<div class="trip-one__address">
	      		<i class="fas fa-map-marker-alt"></i>
	      		<span class="value"><?php echo esc_html($location_address) ?></span>
	      	</div>
	      <?php } ?>

      		<div class="trip-one__price trip__price">
		   		<label class="trip-one__price-label">
		   			<i class="fa-solid fa-circle-dollar-to-slot"></i>
		   			<?php echo esc_html__('From', 'gowilds'); ?>
		   		</label>
		   		<span class="trip-one__price-number">
						<?php	
         ...
         <div class="trip-one__meta">
         	<div class="booking-one__meta-left">
		      	...
		      	<?php if ( $meta->duration['days'] != 0 ) : ?>
						<span class="trip-one__item-meta trip-one__item-duration">
			      ...
			      <?php if($max_capacity){ ?>
			      	<span class="trip-one__item-meta trip-one__max-capacity">
