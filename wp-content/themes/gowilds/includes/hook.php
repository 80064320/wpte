...
add_action( 'wp_travel_engine_breadcrumb_holder', 'gowilds_breadcrumb', '10' );
...
function gowilds_nav_items( $items, $menu, $args ) {
  	if( is_admin() ){
    	return $items;
  	}
...
add_filter( 'wp_get_nav_menu_items', 'gowilds_nav_items', 11, 3 );
